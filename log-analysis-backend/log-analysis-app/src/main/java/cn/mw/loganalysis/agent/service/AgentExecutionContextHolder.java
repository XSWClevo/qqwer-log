 ...
 */
final class AgentExecutionContextHolder {
    ...
    static void set(AgentExecutionContext context) {
        CONTEXT.set(context);
    }

    static AgentExecutionContext get() {
        return CONTEXT.get();
    }

    static AgentExecutionContext require() {
